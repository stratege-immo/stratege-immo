...
<a href="https://stratege-immo.fr/index.html#simulation"
   style="background:#3ECFB4;color:#1B2E3D;padding:14px 32px;border-radius:999px;text-decoration:none;font-weight:600;font-size:15px;display:inline-block">
Lancer ma première simulation</a></div>`);
}

function simulationEmail(prenom, r) {
  return wrap(`
<h2 style="color:#1B2E3D;font-family:Georgia,serif;margin:0 0 16px">Votre simulation, ${prenom}</h2>
<p style="color:#3F4E66;font-size:16px;line-height:1.6;margin:0 0 24px">
...
<td style="padding:12px 16px;background:#f5f9fb;text-align:right;font-weight:700;color:#1B2E3D;font-size:18px">${fmt(r.budget_total)} €</td></tr>
<tr><td style="padding:12px 16px;font-size:14px;color:#6B7F99">Mensualité</td>
<td style="padding:12px 16px;text-align:right;font-weight:600;color:#1B2E3D">${fmt(r.mensualite)} €/mois</td></tr>
<tr><td style="padding:12px 16px;background:#f5f9fb;font-size:14px;color:#6B7F99">Loyer estimé</td>
<td style="padding:12px 16px;background:#f5f9fb;text-align:right;font-weight:600;color:#1B2E3D">${fmt(r.loyer_mensuel_estime)} €/mois</td></tr>
...
<td style="padding:12px 16px;background:#f5f9fb;text-align:right;font-weight:600;color:#1B2E3D">${fmt(r.economie_fiscale_annuelle)} €/an</td></tr>
<tr><td style="padding:12px 16px;font-size:14px;color:#6B7F99;border-radius:0 0 8px 8px">Dispositif</td>
<td style="padding:12px 16px;text-align:right;font-weight:600;color:#1B2E3D;border-radius:0 0 8px 8px">${r.dispositif}</td></tr>
</table>
...
function contactEmail(prenom, reference) {
  return wrap(`
<h2 style="color:#1B2E3D;font-family:Georgia,serif;margin:0 0 16px">Demande enregistrée !</h2>
<p style="color:#3F4E66;font-size:16px;line-height:1.6;margin:0 0 24px">
...
<div style="font-size:28px;font-weight:700;color:#1B2E3D;font-family:Georgia,serif">${reference}</div>
</div>`);
}
